...
class Certificate {
    ...
    async _checkDelegationAndGetKey(d) {
        ...
        if (this._canisterId.compareTo(_dfinity_principal__WEBPACK_IMPORTED_MODULE_4__.Principal.managementCanister()) !== 'eq') {
...
/***/ "./src/declarations/four_backend/four_backend.did.js":
/*!***********************************************************!*\
  !*** ./src/declarations/four_backend/four_backend.did.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/four_backend/index.js":
/*!************************************************!*\
  !*** ./src/declarations/four_backend/index.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "four_backend": () => (/* binding */ four_backend),
/* harmony export */   "idlFactory": () => (/* reexport safe */ _four_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
...
/* harmony import */ var _four_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./four_backend.did.js */ "./src/declarations/four_backend/four_backend.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./four_backend.did.js")._SERVICE>}
 */
const createActor = (canisterId, options) => {
  const agent = new _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.HttpAgent(options ? { ...options.agentOptions } : {});
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_four_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the four_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./four_backend.did.js")._SERVICE>}
 */
const four_backend = createActor(canisterId);
...
"use strict";
/*!****************************************!*\
  !*** ./src/four_frontend/src/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_four_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/four_backend */ "./src/declarations/four_backend/index.js");
...
document.querySelector("form").addEventListener("submit", async (e) => {
  ...
  const greeting = await _declarations_four_backend__WEBPACK_IMPORTED_MODULE_0__.four_backend.greet(name);
